...
if (empty($_SESSION['id']) &&
    ...
    require_once('../process/connexion.php');
        $listProduct = $db->prepare("SELECT * FROM products JOIN category ON products.id = category.id_product WHERE name_category='Site Web'");
        $listProduct->execute();
...
<main>
    <h1 class="textColor text-center my-3">Liste des produits de la catégorie : Site Web</h1>
